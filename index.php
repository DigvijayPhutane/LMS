...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        <h1 class="my-content">Welcome to Thinkers-Mind</h1>
    ...
    <div class="container mt-5"> <!-- Start Explore our Courses-->
      <h1 class="text-center">Explore our Courses</h1>
      <div class="card-deck mt-4"> <!-- Start Explore our Courses1st Card Deck -->
        <?php
        ...
        ?>   
      </div>  <!-- End Explore our Courses1st Card Deck -->   
      <div class="card-deck mt-4"> <!-- Start Explore our Courses2nd Card Deck -->
        <?php
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>Thinkers-Mind provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Thinkers-Mind Pvt Ltd <br> Near priyadarshani <br> sion - mumbai <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
